    ...
    return (
        ...
        >
            <Link className="search__user-link">
                ...
                ></Avatar>
                <Typography color={theme.palette.textColor.content}>{user.fullName}</Typography>
            </Link>
        </ListItem>
    );
}
