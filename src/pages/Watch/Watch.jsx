...
function Watch() {
    ...
    const [originalVideoCategories, setOriginalVideoCategories] = useState(mockVideoList);
    const [filteredVideoCategories, setFilteredVideoCategories] = useState(mockVideoList);
